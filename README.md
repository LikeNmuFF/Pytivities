...
2. Create your feature branch (`git checkout -b feature/AmazingActivity`)
3. Commit your changes (`git commit -m 'Add some AmazingActivity'`)
4. Push to the branch (`git push origin feature/AmazingActivity`)
